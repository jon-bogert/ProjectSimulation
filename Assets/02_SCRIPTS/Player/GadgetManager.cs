...
public class GadgetManager : MonoBehaviour
{
    ...
    [SerializeField] GameObject _handVisual;
    [SerializeField] GameObject _dataLink;
    [SerializeField] GameObject _grappleHook;
    [SerializeField] GameObject _drone;
    [SerializeField] GameObject _impulseCannon;
    [SerializeField] GameObject _plasmaCutter;
